...
export const START1 = [
    ...
    '<strong class="clickable">a Hangover.</strong>',
...
export const START3 = [
    ...
    '<strong class="clickable">Optic camo suit</strong>. Stationary: invisible. Moving: hard to see. d6 uses',
...
export const WEAPONS = [
    ...
    `<strong class="clickable">Shotgun.</strong> d8 damage, d4 mags`,
    `<strong class="clickable">Monosword.</strong> d8 damage`,
    `<strong class="clickable">Assault rifle.</strong> d8a damage, d4 mags`,
    `<strong class="clickable">Assault rifle with a grenade launcher.</strong> d8a damage, d6 damage to up to d3 targets, d4 mags`,
    `<strong class="clickable">Pulse rifle.</strong> d10a damage, d4 mags`,
    `<strong class="clickable">Sniper rifle.</strong> 2d10 damage, x3 crit. When aiming for 2 rounds: -4DR and +2 damage, d4 mags`,
];

export const ARMOR = [
    `<strong class="clickable">No armor</strong>.`,
    `<strong class="clickable">StyleGuard armor.</strong> tier 1, -d2 damage, looks just like clothes!`,
    `<strong class="clickable">Rough armor.</strong> tier 2, -d4 damage, a heavy duty jacket or full kevlar`,
    `<strong class="clickable">SmartWear armor.</strong> tier 2, -d4 damage, equipped with adrenachrome_HST autoinjector that fires if the wearer is battered.`,
